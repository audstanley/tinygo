...
const (
	...
	SPI0_COPI_PIN = PA12 // COPI: SERCOM2/PAD[0]
	SPI0_CIPO_PIN = PA14 // CIPO: SERCOM2/PAD[2]

	NINA_COPI = SPI0_COPI_PIN
	NINA_CIPO = SPI0_CIPO_PIN
	NINA_SCK  = SPI0_SCK_PIN
)

const (
	SPI1_SCK_PIN  = D12 // CIPO: SERCOM1/PAD[1]
	SPI1_COPI_PIN = D11 // COPI: SERCOM1/PAD[3]
	SPI1_CIPO_PIN = D13 // SCK:  SERCOM1/PAD[0]
)
