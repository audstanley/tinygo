...
func (spi SPI) configurePins(config SPIConfig) {
	...
	config.COPI.ConfigureAltFunc(PinConfig{Mode: PinModeSPICOPI}, spi.AltFuncSelector)
	config.CIPO.ConfigureAltFunc(PinConfig{Mode: PinModeSPICIPO}, spi.AltFuncSelector)
}
