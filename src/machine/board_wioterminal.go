...
const (
	...
	SDCARD_CIPO_PIN = PIN_SPI2_CIPO
	SDCARD_COPI_PIN = PIN_SPI2_COPI
	SDCARD_SCK_PIN  = PIN_SPI2_SCK
	SDCARD_SS_PIN   = PIN_SPI2_SS
	SDCARD_DET_PIN  = PD21

	LCD_CIPO_PIN  = PIN_SPI3_CIPO
	LCD_COPI_PIN  = PIN_SPI3_COPI
	...
	// Needed for RTL8720D
	RTL8720D_CIPO_PIN = PIN_SPI1_CIPO
	RTL8720D_COPI_PIN = PIN_SPI1_COPI
...
const (
	...
	SPI0_COPI_PIN = COPI // COPI: SERCOM5/PAD[0]
	SPI0_CIPO_PIN = CIPO // CIPO: SERCOM5/PAD[2]

	// RTL8720D
	SPI1_SCK_PIN  = SCK1  // SCK:  SERCOM0/PAD[1]
	SPI1_COPI_PIN = COPI1 // COPI: SERCOM0/PAD[0]
	SPI1_CIPO_PIN = CIPO1 // CIPO: SERCOM0/PAD[2]

	// SD
	SPI2_SCK_PIN  = SCK2  // SCK:  SERCOM6/PAD[1]
	SPI2_COPI_PIN = COPI2 // COPI: SERCOM6/PAD[0]
	SPI2_CIPO_PIN = CIPO2 // CIPO: SERCOM6/PAD[2]

	// LCD
	SPI3_SCK_PIN  = SCK3  // SCK:  SERCOM7/PAD[1]
	SPI3_COPI_PIN = COPI3 // COPI: SERCOM7/PAD[3]
	SPI3_CIPO_PIN = CIPO3 // CIPO: SERCOM7/PAD[2]
)
