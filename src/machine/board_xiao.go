...
const (
	...
	D9  = PA05 // can be used for PWM or SPI CIPO
	D10 = PA06 // can be used for PWM or SPI COPI
)
...
const (
	...
	SPI0_COPI_PIN = PA06 // COPI: SERCOM0/PAD[2]
	SPI0_CIPO_PIN = PA05 // CIPO: SERCOM0/PAD[1]
)
